...
template <size_t WrListCap, size_t SgeListCap>
int WorkRequest<WrListCap, SgeListCap>::Add(ibv_wr_opcode opcode, void *local,
...
template <size_t WrListCap, size_t SgeListCap>
int WorkRequest<WrListCap, SgeListCap>::Recv(void *local, size_t length)
{
    if (has_recv_wr)
    {
...
using DefaultWorkRequest = WorkRequest<kDefaultWrListCap, kDefaultSgeListCap>;
